                    ...
                    <tbody>
                        <?php foreach ($aClientes as $pos => $cliente): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?editar=<?php echo $pos; ?>" class="btn btn-secnodary"><i class="fa-solid fa-pen-to-square"></i></a>
                                    <a href="?eliminar=<?php echo $pos; ?>"class="btn btn-secnodary"><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                        <?php endforeach;?>
                    </tbody>
